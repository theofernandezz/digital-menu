...
const items = [
  { id: "1", name: "Empanadas", description: null, price: 8.5, isAvailable: true, tags: [] },
  { id: "2", name: "Milanesa", description: null, price: 14, isAvailable: false, tags: [] },
];

describe("MenuCategorySection", () => {
  it("renders the category heading and every item in it", () => {
    render(<MenuCategorySection name="Starters" description={null} index={0} total={2} items={items} />);
  ...
  it("renders no item rows for an empty category", () => {
    render(<MenuCategorySection name="Empty" description={null} index={0} total={1} items={[]} />);
