...
- **Pending for the hosted project, in order, before merging to `main`** (SQL Editor, each inside `begin; ... commit;`): `20260921000000` (ordering schema), `20260921120000` (grants — re-run the current version, see 6c), `20260921130000` (RPCs). Then re-run the grants check query.
